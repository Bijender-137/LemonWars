            ...
            <div className="md:w-1/2 md:pe-4 h-[280px] sm:h-[320px]">
              <div className="flex items-center justify-center md:justify-normal gap-6 after:content-[''] after:w-[262px] after:absolute after:h-[2px] after:bg-[#E5E5E5] after:bottom-[-4px] relative after:rounded-[10px]">
                ...
                >
                  Hosting
                  {activeTab === 1 && (
                    <div className="absolute bottom-[-4px] left-1/2 transform -translate-x-1/2 w-4/5 h-[2px] bg_red" />
                  )}
                </div>
                <div
                  className={`cursor-pointer font-semibold text-[15px] font-poppins relative ${
              ...
              <div className="flex items-center justify-center md:justify-normal pt-5 md:pt-10 xl:pt-[60px]">
                <button
                  type="button"
                  className="text-[13px] sm:text-[14px] w-[160px] font-poppins font-normal text-white border border-transparent bg_red hover:border-black hover:bg-black transition-all ease-linear duration-300 p-2 sm:p-3 rounded-[8px] creat_account_button_shadow leading-[22px] "
                >
                  Create an Account
                </button>
                <button
